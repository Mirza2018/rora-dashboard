      ...
      <div className="flex items-center justify-start">
        <div>
          <h1 className="text-title text-3xl font-bold flex items-center justify-start">
            {" "}
            <ChevronLeft onClick={handleBack} size={40} className="cursor-pointer" /> Trems and Privacy Edit
          </h1>
        </div>
      </div>
      <div className="h-96 ">
...
export default TermsAndPrivacyEditPage;
